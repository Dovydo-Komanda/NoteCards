...
namespace NoteCards.Animations;
...
public sealed class GridLengthAnimation : AnimationTimeline
{
    ...
    {
        var fromValue = From.IsAbsolute ? From.Value : ((GridLength)defaultOriginValue).Value;
        var toValue = To.IsAbsolute ? To.Value : ((GridLength)defaultDestinationValue).Value;
